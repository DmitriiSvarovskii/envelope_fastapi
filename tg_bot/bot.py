...
TOKEN = '5684593983:AAEZUn_fKhmTQV-SLr3p7EDcikT6dLQyCPg'
...
BASE_WEBHOOK_URL = "https://swarovskidmitrii.ru"

# Path to SSL certificate and private key for self-signed certificate.
WEBHOOK_SSL_CERT = "/etc/letsencrypt/live/swarovskidmitrii.ru/cert.pem"
WEBHOOK_SSL_PRIV = "/etc/letsencrypt/live/swarovskidmitrii.ru/privkey.pem"
...
def main() -> None:
    ...
    web.run_app(app, host=WEB_SERVER_HOST,
                port=WEB_SERVER_PORT, ssl_context=context)
